...
form.addEventListener("submit", (e) => {
    ...
    if(fName.value.trim() === "") {
        showMessage("Please enter your first name", fName)
        return;
    }
    else if(lName.value.trim() === "") {
        showMessage("Please enter your last name", lName)
        return;
    ...
    <td>${email.value.trim()}</td>
    <td>
        <button class="delete-btn btn btn-danger btn-sm">Delete</button></td>
    </tr>
    `;
